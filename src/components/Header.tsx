...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-64 h-16 bg-white border-b border-[#e6eeff] shadow-[0_1px_8px_rgba(0,0,0,0.03)] z-40 flex items-center justify-between px-5 transition-all">
      ...
      <div className="flex items-center gap-3 flex-1 max-w-xl">
        ...
        >
          ...
          <div className="w-full h-8 pr-9 pl-16 rounded bg-[#eff4ff] border border-transparent group-hover:border-[#c4c6cf] text-xs text-[#0d1c2e] flex items-center select-none transition-colors">
            <span className="text-[#74777f]">جستجو در اسناد، کالاها و کد پیگیری...</span>
          </div>
          <div className="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none">
            <kbd className="px-1.5 py-0.5 rounded bg-[#e6eeff] text-[11px] font-mono text-[#505f7b] font-tabular">
              Ctrl + K
            </kbd>
          </div>
        </div>
        ...
        <div className="hidden xl:flex items-center gap-1.5 px-3 py-1 rounded bg-[#eff4ff] text-[#505f7b] text-[11px] border border-[#d5e3fc] relative">
          <button
            onClick={() => setShowSubDropdown(!showSubDropdown)}
            className="flex items-center gap-1 hover:text-[#002045] font-medium"
            type="button"
          >
      ...
      <div className="flex items-center gap-3">
        <div className="hidden lg:flex items-center gap-1.5 px-3 py-1 rounded bg-[#e6eeff] text-[#52617e] text-[11px]">
        ...
        <button
          ...
          className="h-8 px-3.5 rounded bg-[#002045] hover:bg-[#1a365d] text-white text-xs font-semibold flex items-center gap-1.5 transition-colors shadow-sm"
          type="button"
        >
        ...
        {/* User Profile */}
        <div className="flex items-center gap-2.5 pr-2 border-r border-[#e6eeff]">
          <div className="hidden md:flex flex-col items-end">
            <span className="text-xs font-bold text-[#0d1c2e]">مهندس علیرضا رادمنش</span>
          ...
          <div className="w-8 h-8 rounded-full bg-[#002045] text-white flex items-center justify-center font-bold text-xs">
