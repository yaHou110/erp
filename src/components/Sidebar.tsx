...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="fixed top-0 right-0 h-screen w-64 bg-white border-l border-[#e6eeff] shadow-[0_1px_8px_rgba(0,0,0,0.03)] z-50 flex flex-col justify-between select-none">
      <div className="flex flex-col">
        {/* Brand Header */}
        <div className="h-16 px-4 flex items-center justify-between bg-[#eff4ff] border-b border-[#e6eeff]">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded bg-[#002045] flex items-center justify-center text-white shadow-sm">
          ...
          <button
            className="w-7 h-7 flex items-center justify-center rounded bg-[#e6eeff] hover:bg-[#dce9ff] text-[#0d1c2e] transition-colors"
      ...
      <div className="p-3 bg-[#eff4ff] border-t border-[#d5e3fc] flex flex-col gap-1.5">
